package com.zhuj.android.zui.widget.badge;
...
public class BadgeView extends androidx.appcompat.widget.AppCompatTextView {
     ...
     */
    public void bindTargetView(View target) {
        if (target == null) {
        ...
        if (target.getParent() instanceof FrameLayout) {
            ...
            int targetIndex = parentContainer.indexOfChild(target);
            parentContainer.removeView(target);

            FrameLayout badgeContainer = new FrameLayout(getContext());
            ViewGroup.LayoutParams parentLayoutParams = target.getLayoutParams();
            badgeContainer.setLayoutParams(parentLayoutParams);
            parentContainer.addView(badgeContainer, targetIndex);
