...
//                    .resize(100, 100)
//                    .centerCrop().
//                    transform(new RoundTransform(DownloaderActivity.this.getApplicationContext()))
...
//                            nativeDownloadViewHolder.mStatusButton.setText("出错");
//                        }
//                        Toast.makeText(DownloaderActivity.this, downloadException.getMsg(), Toast.LENGTH_LONG).show();
//                    }
//                    return super.onResult(throwable, uri, url, extra);
//                }
//            });
