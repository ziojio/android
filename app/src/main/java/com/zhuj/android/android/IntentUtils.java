...
import com.zhuj.android.util.StringUtils;
...
import static com.zhuj.android.android.IntentUtils.DocumentType.AUDIO;
import static com.zhuj.android.android.IntentUtils.DocumentType.VIDEO;
import static com.zhuj.code.common.FileUtils.getFileByPath;
...
public final class IntentUtils {
    ...
    public static Intent getInstallAppIntent(final String filePath, final String authority) {
        return getInstallAppIntent( filePath, authority);
    }
     ...
     * @return 安装 App(支持 8.0)的意图
     */
    public static Intent getInstallAppIntent(Context context, final File file, final String authority, final boolean isNewTask) {
        if (file == null) {
            return null;
        }
     ...
     * @return App 具体设置的意图
     */
    public static Intent getAppDetailsSettingsIntent(final String packageName, final boolean isNewTask) {
     ...
     * 选择文件的类型
     */
    @StringDef(value = {DocumentType.IMAGE, DocumentType.AUDIO, DocumentType.VIDEO, DocumentType.ANY})
