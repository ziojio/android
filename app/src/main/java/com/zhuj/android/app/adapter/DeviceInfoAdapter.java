// package com.zhuj.android.app.adapter;
//
//
...
// import com.zhuj.android.app.model.DeviceInfo;
//
...
//     // 数据源
//     private ArrayList<DeviceInfo> listDatas = new ArrayList<>();
//
//     /**
//      * 初始化适配器
//      * @param mActivity
...
//         // 获取实体类
//         DeviceInfo phoneInfoItem = listDatas.get(position);
//         // 判断类型
//         if (holder.iType == 0){
//             // 设置提示文案
...
//      * @param listDatas
//      */
//     public void setListDatas(ArrayList<DeviceInfo> listDatas) {
//         if (listDatas == null){
//             return;
//         }
