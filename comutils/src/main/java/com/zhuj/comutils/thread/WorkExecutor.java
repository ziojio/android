package com.zhuj.comutils.thread;
...
public class WorkExecutor implements Executor {
    ...
    public <T> Future<T> addTask(final Runnable task, final T result) {
        return mPoolExecutor.submit(task, result);
    }
    ...
    public <T> List<Future<T>> invokeAll(final Collection<? extends Callable<T>> tasks)
        ...
        return mPoolExecutor.invokeAll(tasks);
    }
    ...
    public <T> List<Future<T>> invokeAll(final Collection<? extends Callable<T>> tasks,
        ...
        return mPoolExecutor.invokeAll(tasks, timeout, unit);
    }
    ...
    public <T> T invokeAny(final Collection<? extends Callable<T>> tasks)
        ...
        return mPoolExecutor.invokeAny(tasks);
    }
    ...
    public <T> T invokeAny(final Collection<? extends Callable<T>> tasks,
        ...
        return mPoolExecutor.invokeAny(tasks, timeout, unit);
    }
