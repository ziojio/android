...
public final class ScreenUtils {
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) Androids.getContext().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static void setSleepDuration(final int duration) {
        Settings.System.putInt(
                Androids.getContext().getContentResolver(),
    ...
    public static void cancelAdaptScreen(final Activity activity) {
        final DisplayMetrics appDm = Androids.getContext().getResources().getDisplayMetrics();
