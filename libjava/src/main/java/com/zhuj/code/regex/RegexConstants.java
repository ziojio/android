...
public final class RegexConstants {
     ...
     */
    public static final String MOBILE_EXACT = "^((13[0-9])|(14[5,7])|(15[0-3,5-9])|(16[6])|(17[0,1,3,5-8])|(18[0-9])|(19[8,9]))\\d{8}$";
    /**
     ...
     */
    public static final String ID_CARD15 = "^[1-9]\\d{7}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}$";
    /**
     * Regex of id card number which length is 18.
     */
    public static final String ID_CARD18 = "^[1-9]\\d{5}[1-9]\\d{3}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}([0-9Xx])$";
    /**
     * Regex of email.
     */
    ...
    public static final String HTTP_URL = "^(http|https)://[^\\s]*";

    /**
     * Regex of #FF123456 or #FF123 or #123456 or #123
     */
    public static final String COLOR = "^#([0-9a-fA-F]{2}|)([0-9a-fA-F]{6}|[0-9a-fA-F]{3})$";
    /**
