...
public final class PermissionUtils {
    ...
    private static final List<String> MANIFEST_PERMISSIONS = getPermissions(Androids.getContext());
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                || PackageManager.PERMISSION_GRANTED == ContextCompat.checkSelfPermission(Androids.getContext(), permission);
    }
    ...
    public static void openAppSettings() {
        ...
        intent.setData(Uri.parse("package:" + Androids.getContext().getPackageName()));
        Androids.getContext().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public void request() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            if (mPermissionsRequest.isEmpty()) {
                ...
                startPermissionActivity(Androids.getContext());
            }
        }
    }
