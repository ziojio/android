package com.zhuj.android.base.view;
...
public class CircleView extends View {
    ...
    public CircleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        paintColor = ta.getColor(R.styleable.CircleView_penColor, Color.BLACK);
        outBorderColor = ta.getColor(R.styleable.CircleView_penColor, Color.BLACK);
        radiusLevel = ta.getInteger(R.styleable.CircleView_sizeLevel, 2);
        // circleRadius = dip2px(context, PaintSettingWindow.PEN_SIZES[radiusLevel]);
