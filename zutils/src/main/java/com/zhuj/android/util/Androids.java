...
import com.zhuj.android.util.helper.ActivityLifecycleHelper;
import com.zhuj.android.util.logger.Logger;
import com.zhuj.android.util.thread.MainExecutor;
...
public class Androids {
    ...
    public static void debug(boolean isDebug) {
        ...
        if (isDebug) {
            ((Application) Androids.getApp()).registerActivityLifecycleCallbacks(getActivityLifecycleHelper());
        }
    }
    ...
    public static String getExternalCacheDirPath() {
        if (CACHE_DIR == null) {
            CACHE_DIR = getApp().getExternalCacheDir().getAbsolutePath();
        }
        return CACHE_DIR;
    }
    ...
    public static String getExternalFileDirPath() {
        if (FILE_DIR == null) {
            FILE_DIR = getApp().getExternalFilesDir(null).getAbsolutePath();
        }
        return FILE_DIR;
    }
