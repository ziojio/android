...
public final class ScreenUtils {
    ...
    public static void drawInStatusBarBackground(Activity activity) {
    ...
    public static void drawInStatusBarBackgroundTranslucentBar(Activity activity) {
        Window window = activity.getWindow();
    ...
    public static void drawInStatusBarBackgroundTransparentBar(Activity activity) {
        Window window = activity.getWindow();
     ...
     * @param activity
     */
    public static void drawInStatusBarBackgroundTransparentStatusBarTranslucentNavigationBar(Activity activity) {
        Window window = activity.getWindow();
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
    ...
    public static void drawInStatusBarBackgroundTransparentStatusBarHideNavigationBar(Activity activity) {
        Window window = activity.getWindow();
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS | WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
        window.setStatusBarColor(Color.TRANSPARENT);
