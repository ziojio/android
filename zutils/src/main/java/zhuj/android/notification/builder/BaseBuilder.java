...
package zhuj.android.notification.builder;
...
import zhuj.android.notification.NotificationUtils;
...
public class BaseBuilder {
    ...
    public void build() {
        ...
        mBuilder = new NotificationCompat.Builder(Androids.getApp(), mChannelId);
        ...
        if (mBigIcon > 0) {
            mBuilder.setLargeIcon(BitmapFactory.decodeResource(Androids.getResources(), mBigIcon));
        }
        // 在顶部状态栏中的提示信息
