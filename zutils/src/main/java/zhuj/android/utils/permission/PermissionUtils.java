package zhuj.android.utils.permission;
...
public final class PermissionUtils {
    ...
    private static final List<String> MANIFEST_PERMISSIONS = getPermissions(Androids.getApp());
    ...
    public static List<String> getPermissions(Context context) {
        ...
        try {
            return Arrays.asList(pm.getPackageInfo(
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                || PackageManager.PERMISSION_GRANTED == ContextCompat.checkSelfPermission(Androids.getApp(), permission);
    }
    ...
    public static void openAppSettings() {
        ...
        intent.setData(Uri.parse("package:" + Androids.getApp().getPackageName()));
        Androids.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private PermissionUtils(final String... permissions) {
        ...
        for (String permission : permissions) {
            for (String aPermission : PermissionConstants.getPermissions(permission)) {
                if (MANIFEST_PERMISSIONS.contains(aPermission)) {
    ...
    public void request() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            if (mPermissionsRequest.isEmpty()) {
                ...
                startPermissionActivity(Androids.getApp());
            }
        }
    }
