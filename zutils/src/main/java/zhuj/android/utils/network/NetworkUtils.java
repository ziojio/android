...
import zhuj.android.utils.util.ShellUtils;
...
public final class NetworkUtils {
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager)  Androids.getApp().getSystemService(Context.TELEPHONY_SERVICE);
            if (tm == null) {
                return false;
            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager)  Androids.getApp().getSystemService(WIFI_SERVICE);
        if (manager == null) {
            return false;
        }
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager)  Androids.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
        if (cm == null) {
            return false;
        }
     ...
     * @return type of network
     * <ul>
     * <li>{@link zhuj.android.utils.network.NetworkUtils.NetworkType#NETWORK_ETHERNET} </li>
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager)  Androids.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) {
            return "";
        }
