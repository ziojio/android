package zhuj.android.utils.device;
...
public final class DeviceUtils {
    ...
    public static Map<String, String> getDeviceInfos() {
        ...
        try {
            // 获得包管理器
            PackageManager packageManager = Androids.getPackageManager();
            // 得到该应用的信息，即主Activity
            PackageInfo packageInfo = packageManager.getPackageInfo(Androids.getApp().getPackageName(), PackageManager.GET_ACTIVITIES);
            if (packageInfo != null) {
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            WifiManager wifi = Androids.getSystemService(Context.WIFI_SERVICE);
            if (wifi != null) {
    ...
    public static void reboot() {
        ...
        Androids.getApp().sendBroadcast(intent);
    }
