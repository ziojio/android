...
public final class PackageUtils {
    ...
    public static PackageInfo getPackageInfo(Context context, final String packageName, int flags) {
    ...
    public static boolean isExistsActivity(String packageName, String activityClassName) {
        ...
        try {
             ...
             * 根据 flag 获取指定的额外信息，
             */
            packageInfo = Androids.getPackageManager().getPackageInfo(packageName, PackageManager.GET_ACTIVITIES);
    ...
    public static boolean isExistsService(String packageName, String serviceClassName) {
        PackageInfo packageInfo;
        try {
            /*
             * 根据 flag 获取指定的额外信息，
             */
            packageInfo = Androids.getPackageManager().getPackageInfo(packageName, PackageManager.GET_SERVICES);
    ...
    private static boolean installNormal(Context context, File appFile) {
        try {
            ...
            Log.e("PackageInfo", "使用系统的意图进行apk安装失败！", e);
        }
        return false;
    }
